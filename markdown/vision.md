...
UC 4 - theme switcher
4.1 The user can switch between light and dark mode.
4.2 If the user switches to dark mode, the colors generated by the game are light.
4.3 If the user switches to light mode, the colors generated by the game are dark.
